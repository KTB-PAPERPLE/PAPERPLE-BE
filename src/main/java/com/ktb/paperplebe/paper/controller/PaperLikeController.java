...
public class PaperLikeController {
  ...
  public SuccessResponse increaseLikeCount(
      @AuthenticationPrincipal Long userId, @PathVariable Long paperId)
      throws InterruptedException {
    paperLikeFacade.increaseLikeCount(userId, paperId);
  ...
  public SuccessResponse decreaseLikeCount(
      @AuthenticationPrincipal Long userId, @PathVariable Long paperId)
      throws InterruptedException {
    paperLikeFacade.decreaseLikeCount(userId, paperId);
    return new SuccessResponse();
  }
  ...
  public Map<Long, Boolean> getLikeStatus(
      @AuthenticationPrincipal Long userId, @RequestParam("paperIds") List<Long> paperIds) {
    return paperLikeService.getLikeStatus(userId, paperIds);
  }
}
