...
public class PaperController {
  ...
  @PostMapping("/test")
  public ResponseEntity<?> test(@RequestBody String url) {
    return ResponseEntity.ok(null);
  }

  @PostMapping
  public ResponseEntity<?> createPaper(
      @RequestBody final PaperRequest paperRequest, @AuthenticationPrincipal Long userId) {
  ...
  public ResponseEntity<?> updatePaper(
      @PathVariable Long paperId, @RequestBody final PaperRequest paperRequest) {
  ...
  public ResponseEntity<?> deletePaper(@PathVariable Long paperId) {
    ...
    return ResponseEntity.ok(Map.of("message", "Paper successfully deleted"));
  }
}
